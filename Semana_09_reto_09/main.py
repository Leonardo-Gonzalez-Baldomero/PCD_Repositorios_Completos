...
for i, cat in enumerate(categorias):
    ...
    indices_bajas = np.random.choice(
        [idx for idx in range(n_transacciones_por_cat) if idx not in indices_altas],
...
# =====================================================================
# PARTE 1: ANÁLISIS ESTADÍSTICO POR CATEGORÍA
# =====================================================================
...
print(f"{'Categoría':<20} {'Media':>12} {'Mediana':>12} {'Std':>12} {'Mín':>10} {'Máx':>10}")
print("─" * 80)
for i, cat in enumerate(categorias):
...
print(f"{'Categoría':<20} {'Q1 (25%)':>12} {'Q2 (50%)':>12} {'Q3 (75%)':>12} {'IQR':>12}")
print("─" * 72)
for i, cat in enumerate(categorias):
...
print(f"{'Categoría':<20} {'Límite Inf':>15} {'Límite Sup':>15} {'Rango Válido':>20}")
print("─" * 75)
for i, cat in enumerate(categorias):
...
print(f"{'Categoría':<20} {'Total Trans.':>12} {'Outliers':>10} {'% Anomalías':>12} {'Inf.':>8} {'Sup.':>8}")
print("─" * 75)
for i, cat in enumerate(categorias):
...
# =====================================================================
# PARTE 3: DETECCIÓN DE OUTLIERS CON Z-SCORE
# =====================================================================
...
print(f"{'Categoría':<20} {'Media Z':>10} {'Std Z':>10} {'Min Z':>10} {'Max Z':>10}")
print("─" * 65)
for i, cat in enumerate(categorias):
    zs = zscores_matriz[i]
...
print(f"{'Categoría':<20} {'Total Trans.':>12} {'Outliers':>10} {'% Anomalías':>12} {'Z<-3':>8} {'Z>3':>8}")
print("─" * 75)
for i, cat in enumerate(categorias):
...
# =====================================================================
# PARTE 4: COMPARACIÓN Y REPORTE FINAL
# =====================================================================
...
total_outliers_unicos = 0
for cat in categorias:
    total_outliers_unicos += len(set(outliers_iqr[cat]['ids']) | set(outliers_zscore[cat]['ids']))
...
# =====================================================================
# EJERCICIO BONUS: ANÁLISIS DE CORRELACIÓN
# =====================================================================
